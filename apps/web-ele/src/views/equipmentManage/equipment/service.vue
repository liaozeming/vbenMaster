...
<div>
  <el-row :gutter="20">
    <el-col :span="6">
      <el-select v-model="service" placeholder="请选择" @change="timeChange" clearable>
  ...
  <el-row :gutter="20">
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="name" label="服务名称" width="260">
      </el-table-column>
      <el-table-column prop="in" label="输入参数" width="280">
      </el-table-column>
...
import { getServiceData } from '#/api/core/tsl'
...
const showServiceData = async (equipmentId: any) => {
  let params = {
    identifier: service.value,
    equipmentId: equipmentId,
    startTime: timeRange.value[0],
    endTime: timeRange.value[1],
  }
  tableData.value = await getServiceData(params)
}
...
watch(
  ...
  (newVal) => {
    ...
    showServiceData(props.equipmentId)
  },
...
const timeChange = async () => {
  showServiceData(equipmentId.value)
}
</script>
